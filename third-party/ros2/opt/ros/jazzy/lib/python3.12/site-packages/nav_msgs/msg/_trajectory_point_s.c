...
bool nav_msgs__msg__trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav_msgs.msg._trajectory_point.TrajectoryPoint", full_classname_dest, 46) == 0);
  }
  nav_msgs__msg__TrajectoryPoint * ros_message = _ros_message;
  {  // header
  ...
  {  // effort
    ...
    if (!geometry_msgs__msg__wrench__convert_from_py(field, &ros_message->effort)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * nav_msgs__msg__trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav_msgs.msg._trajectory_point");
  ...
  {  // effort
    PyObject * field = NULL;
    field = geometry_msgs__msg__wrench__convert_to_py(&ros_message->effort);
    if (!field) {
      return NULL;
    }
    {
